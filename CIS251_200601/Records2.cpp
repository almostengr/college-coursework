...
// Assignment: Program Example from chapter 14
// File:       Records2.cpp
// Purpose:    Reads magazine sales records, calculates commission rate and commission
//             for each record and prints sales report.
...
//             Illustrates using records, file I/O, dynamic memory, linked list.
// Input:      Input file name and output file name. Records read from file. sales.txt
#include <iostream>
#include <fstream> // I/O
