...
public class Project7 extends JFrame{
	...
	public void paint(Graphics g){
		...
		Global.displayOnScreen.fillOval(xVariable01,y*2,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable02,y+10,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable03,y+2,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable04,y+1,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable05,y/3,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable06,y+2,20,20);

		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable07,y+3,20,20);
		
		Global.displayOnScreen.setColor(Color.red);
		Global.displayOnScreen.fillOval(xVariable08,y/2,20,20);
		y++;
		int yTester = (int)y/3;
		if(yTester>450){
