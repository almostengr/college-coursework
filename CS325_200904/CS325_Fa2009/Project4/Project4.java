...
public class Project4 extends JFrame {
	...
	//FOR SIGNAL INDICATORS: 0 = RED, 1 = YELLOW, 2 = GREEN
	...
	*/
	public Project4(){
		...
		Thread animate = new Thread(){
			public void run(){
			int pacman_Dir = 5; 	//HOW FAST DOES PACMAN MOVE
			
				while(true){
	
					x += pacman_Dir;	//REPOSITIONS PACMAN IMITATING MOVEMENT
	
					if (x > (width-90) || x < 0){	
					//SET SO THAT PACMAN DOESN'T RUN PASS THE BORDER OF THE SCREEN
						
						pacman_Dir *= -1;	//CHANGES DIRECTION
						if(goingRight == true){
							goingRight = false;
	...
	*/
	public static void main(String args[]){
		...
		d.setTitle("Project 4 Animation");
		d.setVisible(true);
