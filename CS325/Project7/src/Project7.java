...
public class Project7 extends JFrame{
	...
	public void paint(Graphics g){
		...
		Global.displayOnScreen.setColor(Color.orange);
		Global.displayOnScreen.fillOval((xVariable01++)+5,(yVariable01)*2,20,20);
		
		if(yVariable01<200 && hasHitGround==false){
			yVariable01++;
			System.out.println("first, " + yVariable01 + ", " + hasHitGround);
			
		}
		if(yVariable01==200 && hasHitGround==false){
			--yVariable01;
			hasHitGround=true;
			System.out.println("second, " + hasHitGround);
		}
		
		if(yVariable01>50 && hasHitGround==true){
			yVariable01--;
			System.out.println("third, " + yVariable01 + ", " + hasHitGround);
		}
		if(yVariable01==50 && hasHitGround==true){
			yVariable01++;
			hasHitGround=false;
		...
		if(yVariable01>50 && hasHitGround==false){
			yVariable01++;
