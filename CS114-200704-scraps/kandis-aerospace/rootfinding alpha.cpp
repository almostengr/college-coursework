...
double xLeft = -180;  // the initial left boundary
double xRight = 0; // the initial right boundary
...
double f ( double x)
{
double value, log1, log2, log3, stage1, stage2, stage3;

double num1, num2, num3, den1, den2, den3, get_log1, get_log2, get_log3;
...
value = 29000 - stage1 - stage2 - stage3;
