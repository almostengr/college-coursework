...
/*	output 
Demonstration of vectors and lists and sets


Enter the number of elements to be inserted : 2
Adding 2 elements to a vector
        finished
Adding 2 elements to a list
        finished
Adding 2 elements to a set
        finished


How many numbers do you want to find in the vector/list/set ? 1

Finding 1 values in a vector
        Vector: searched for 1 values, found 1 and could not find 0

Finding 1 values in a list
        List: searched for 1 values, found 1 and could not find 0

Finding 1 values in a set
        Set: searched for 1 values, found 1 and could not find 0
